...
class adLDAP {
	...
	var $_account_suffix="@testad.ark.org";
	var $_base_dn = "DC=testad,DC=ark,DC=org"; 
	
	// An array of domain controllers. Specify multiple controllers if you 
	// would like the class to balance the LDAP queries amongst multiple servers
	var $_domain_controllers = array ("172.20.55.71");
	
	// optional account with higher privileges for searching
	// not really that optional because you can't query much as a user
	var $_ad_username='pwadmin';
	var $_ad_password='StrongAuth!';
...
# 					echo ("FATAL: AD bind failed. Check the login credentials."); exit();
	...
	function user_email_search($email,$fields=NULL){
