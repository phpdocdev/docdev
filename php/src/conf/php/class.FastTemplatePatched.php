...
//	************************************************************
	...
	function FastTemplatePatched ($pathToTemplates = "")
	{
		global $php_errormsg;
...
//	************************************************************
	...
	function FastPrint ( $template = "", $output=0 )
	{
...
# What kind of frickin' idiot declares a function twice? (See line 516)
