...
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 * @return	object
	 */
	function select($select = '*', $escape = FALSE)//jay addition, make escape default to FALSE
	{
...
//		return $this;
//	}
	function join($table, $cond, $type = '')//jay change, reverting to 1.6.3 function bc new one breaks existing queries
	{		
		if ($type != '')
		{
			$type = strtoupper(trim($type));
...
//		return $this;
//	}
	function order_by($orderby, $direction = '')//jay addition reverting to v 1.6.3 bc 1.7.1 breaks some queries
	{
		if (strtolower($direction) == 'random')
		{
			$orderby = ''; // Random results want or don't need a field name
