...
function render_tabs3($active, $param){	
		...
		foreach($param['tabs'] as $id=>$link){
			...
			if($active == $id){
				if( $param['tab_position'] == 'bottom'){
					?>
					  <td class="<?=$param['active_class']?>" rowspan="3" valign="top" width="7"><font face="Arial"><img src="FW_SHARED/tabs/lefttaba<?=$t?>.gif" width="8" height="20" border="0" alt></font></td>
					  <td class="<?=$param['active_class']?>" height="1"></td>
					  <td rowspan="3" class="<?=$param['active_class']?>" valign="top" width="7"><img src="FW_SHARED/tabs/righttaba<?=$t?>.gif" width="7" height="20" border="0"></td>              			
					<?				
				}else{
					?>
					  <td class="<?=$param['active_class']?>" rowspan="3" valign="top" width="7"><font face="Arial"><img src="FW_SHARED/tabs/lefttaba<?=$t?>.gif" width="8" height="20" border="0" alt></font></td>
					  <td bgcolor="#000000" height="1"><font face="Arial"><img src="FW_SHARED/tabs/stretch.gif" width="1" height="1" alt border="0"></font></td>
					  <td rowspan="3" class="<?=$param['active_class']?>" valign="top" width="7"><img src="FW_SHARED/tabs/righttaba<?=$t?>.gif" width="7" height="20" border="0"></td>              			
					<?
				}
			}else{
				?>
				  <td class="<?=$param['inactive_class']?>" rowspan="3" valign="top" width="7"><font face="Arial"><img src="FW_SHARED/tabs/lefttabi<?=$t?>.gif" width="8" height="20" border="0" alt></font></td>
				  <td bgcolor="#000000" height="1"><font face="Arial"><img src="FW_SHARED/tabs/stretch.gif" width="1" height="1" alt border="0"></font></td>
				  <td rowspan="3" class="<?=$param['inactive_class']?>" valign="top" width="7"><img src="FW_SHARED/tabs/righttabi<?=$t?>.gif" width="7" height="20" border="0"></td>              							  
				<?			
			}
			if( $i < count($param['tabs']) ){
				?>
					<td rowspan="3" bgcolor="white" valign="bottom" width="5"><img src="FW_SHARED/tabs/bar<?=$t?>.gif" width="5" height="20" border="0"></td>              				
				<?
			}
		}
